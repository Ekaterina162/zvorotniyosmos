...
def index():
    ...
    return render_template("OS1.html", Ci=Ci, Gv=Gv, Xz=Xz, Xp=Xp, Xr=Xr, Cv=Cv, Gp=Gp, Cp=Cp, Gk=Gk, Ck=Ck, Gr=Gr, Gs=Gs, Gi=Gi, LP=LP, RP=RP, delta=delta)
...
def OS2():
    ...
    delta = float(LP) - float(RP)
    return render_template("OS2.html", Ci=Ci, Gv=Gv, Xz=Xz, Xp=Xp, Xr=Xr, Xr2=Xr2, Cv1=Cv1, Gp1=Gp1, Cp1=Cp1, Gk1=Gk1, Ck1=Ck1, Gr1=Gr1, Gs1=Gs1, Gp2=Gp2, Cp2=Cp2, Gk2=Gk2, Ck2=Ck2, Gr2=Gr2, Gs2=Gs2, Gi2=Gi2, Cv2=Cv2, Gi1=Gi1, LP=LP, RP=RP, delta=delta)
